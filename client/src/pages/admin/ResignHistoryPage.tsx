        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-2xl font-black text-gray-900 tracking-tight">Riwayat Resign Karyawan</h1>
                        <p className="text-sm text-gray-500">Timeline historis seluruh karyawan yang telah resign dari perusahaan.</p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                ...
                <div className="text-xs text-gray-400 font-bold bg-white border border-gray-100 px-3 py-1.5 rounded-full shadow-xs">
                    Total: {filteredResignations.length} Karyawan Resign
                </div>
            </div>
