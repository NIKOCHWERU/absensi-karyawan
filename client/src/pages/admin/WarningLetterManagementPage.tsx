                ...
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 font-medium">Kelola data SP1, SP2, dan SP3 karyawan.</p>
                        </div>
                    </div>
                    <Button
                        onClick={() => { resetForm(); setOpenAddModal(true); }}
                        className="bg-green-600 hover:bg-green-700 text-white rounded-xl shadow-sm gap-2 h-11 px-6 w-full md:w-auto"
                    >
                ...
                <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden bg-white rounded-2xl">
                    <DialogHeader className="px-6 py-4 bg-gray-50 border-b border-gray-100">
                        ...
                        <DialogDescription className="text-xs text-gray-500">
                            Masukkan detail surat peringatan untuk karyawan.
                        </DialogDescription>
                    </DialogHeader>
                    
                    <form onSubmit={handleAddSubmit} className="p-6 space-y-4">
                        <div className="space-y-1.5">
                            <label className="text-xs font-black text-gray-500 uppercase">Pilih Karyawan</label>
                                    ...
                                    <div className="absolute z-10 w-full mt-1 bg-white border border-gray-100 shadow-lg rounded-lg overflow-hidden max-h-48 overflow-y-auto">
                                        {searchedEmployees.map((emp) => (
                                            ...
                                            >
                                                ...
                                                <Button size="sm" variant="ghost" className="h-7 text-xs text-green-600 font-bold hover:bg-green-50">
                                                    Pilih
                                                </Button>
                                            </div>
                                        ))}
                        ...
                        <div className="flex justify-end gap-2.5 pt-3">
                            ...
                            <Button type="submit" disabled={createLetter.isPending} className="bg-green-600 hover:bg-green-700 text-white">
                ...
                <DialogContent className="sm:max-w-[500px] p-0 overflow-hidden bg-white rounded-2xl">
                    ...
                    {selectedLetter && (
                        <div className="p-6 space-y-4">
                            <div>
                                <label className="text-[10px] font-black text-gray-400 uppercase tracking-wider">Karyawan</label>
