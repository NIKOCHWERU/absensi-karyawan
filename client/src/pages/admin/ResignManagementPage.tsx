...
export default function ResignManagementPage() {
    ...
    const handleDelete = (id: number) => {
        if (confirm("Apakah Anda yakin ingin menghapus pencatatan resign ini? Status keaktifan karyawan akan dipulihkan.")) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h1 className="text-2xl font-black text-gray-900 tracking-tight">Manajemen Resign Karyawan</h1>
                    <p className="text-sm text-gray-500">Mencatat, menyunting, dan menghapus dokumen surat resign karyawan.</p>
                </div>
                ...
                <CardContent className="p-0">
                    ...
                    <div className="p-4 sm:p-5 border-b border-gray-100 bg-white flex flex-col sm:flex-row gap-4 items-center justify-between">
                        <div className="relative w-full sm:w-80">
                            ...
                            <Input
                                placeholder="Cari karyawan berdasarkan nama / NIK..."
                                value={searchTerm}
            ...
            {/* Modal: Tambah Karyawan Resign */}
            <Dialog open={openAddModal} onOpenChange={setOpenAddModal}>
                <DialogContent className="max-w-lg rounded-xl">
                    <DialogHeader>
                        <DialogTitle>Catat Karyawan Resign</DialogTitle>
                        <DialogDescription>
                            Daftarkan dokumen surat menyurat resign dan ubah status keaktifan karyawan.
                        </DialogDescription>
                    </DialogHeader>
                    <form onSubmit={handleAddSubmit} className="space-y-4 pt-2">
                                    ...
                                    {activeEmployees.length === 0 ? (
                                        ...
                                        activeEmployees.map((emp) => (
                                            <SelectItem key={emp.id} value={emp.id.toString()}>
                                                {emp.fullName} - {emp.nik || "Tidak ada NIK"} ({emp.position || "Staff"})
                                            </SelectItem>
                                        ))
                                    )}
                                </SelectContent>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <Textarea
                                placeholder="Tulis alasan resign karyawan di sini secara jelas..."
                                value={formReason}
            ...
            <Dialog open={openEditModal} onOpenChange={setOpenEditModal}>
                <DialogContent className="max-w-lg rounded-xl">
                    <DialogHeader>
                        <DialogTitle>Perbarui Data Resign Karyawan</DialogTitle>
                        <DialogDescription>
                    ...
                    {selectedResign && (
                        <form onSubmit={handleEditSubmit} className="space-y-4 pt-2">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-black text-gray-500 uppercase">Keterangan Resign <span className="text-red-500">*</span></label>
                                <Textarea
                                    placeholder="Tulis alasan resign karyawan..."
                                    value={formReason}
                                    onChange={(e) => setFormReason(e.target.value)}
                                    className="rounded-lg border-gray-200 min-h-[100px]"
                                    required
            ...
            <Dialog open={openViewModal} onOpenChange={setOpenViewModal}>
                <DialogContent className="max-w-md rounded-xl">
                    <DialogHeader>
                        <DialogTitle>Detail Resign Karyawan</DialogTitle>
                        <DialogDescription>
                            Informasi detail pencatatan resignasi karyawan PT Elok Jaya Abadhi.
                        </DialogDescription>
                    </DialogHeader>
                    {selectedResign && (
