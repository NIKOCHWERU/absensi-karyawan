...
This is a full-stack employee attendance karyawan system built for Indonesian companies. The application allows employees to clock in/out with photo verification and geolocation, track their attendance history using a custom 26th-25th monthly cycle, and view company announcements. Administrators can manage employees and view attendance records.
...
- **State Karyawan**: TanStack Query for server state, React hooks for local state
...
- **Drizzle ORM**: Type-safe database queries and schema karyawan
...
### Authentication
- **express-session**: Session karyawan
- **connect-pg-simple**: PostgreSQL session store
- **passport / passport-local**: Authentication middleware

### UI/Frontend Libraries
- **@radix-ui/***: Accessible UI primitives (dialogs, dropdowns, forms, etc.)
- **@tanstack/react-query**: Server state karyawan and caching
